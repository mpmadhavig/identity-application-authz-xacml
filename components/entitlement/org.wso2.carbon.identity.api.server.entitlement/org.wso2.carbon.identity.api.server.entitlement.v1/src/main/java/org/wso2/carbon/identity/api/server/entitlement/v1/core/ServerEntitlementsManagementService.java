...
public class ServerEntitlementsManagementService {
    ...
    public PaginatedPolicySetDTO getAllPolicies(String policyTypeFilter, String policySearchString,
        ...
        if (isPDPPolicy) {
            ...
            try {
                ...
                throw new EntitlementServerException("Error while retrieving Light Policy DTOs.", e);
            }
        }
        ...
        for (PolicyDTO policyDTO : policyDTOs) {
            ...
            if (!policySearchString.trim().isEmpty()) {
                ...
                if (!isPDPPolicy) {
                    ...
                    PolicyDTO metaDataPolicyDTO = null;
                    try {
                        metaDataPolicyDTO = EntitlementAdminEngine.getInstance().
                                getPapPolicyStoreManager().getMetaDataPolicy(policyDTO.getPolicyId());
                    } catch (EntitlementException e) {
                        throw new EntitlementServerException(
                                "Error occurred while filtering out policies based on attribute value", e);
                    }
    ...
    public PublisherDataHolder getSubscriber(String subscribeId) throws EntitlementException {
        ...
        SubscriberPersistenceManager
                subscriberManager = EntitlementAdminEngine.getInstance().getSubscriberPersistenceManager();
    ...
    public String[] getSubscriberIds(String searchString) throws EntitlementException {
        ...
        SubscriberPersistenceManager subscriberManager =
                EntitlementAdminEngine.getInstance().getSubscriberPersistenceManager();
     ...
     * @throws EntitlementException If an error occurs while publishing the policies.
     */
     ...
     *
     * @return PublisherDataHolder array.
     */
    ...
    /**
     * @return Entitlement Finder Data Holder array.
     */
     ...
     * @throws EntitlementException If an error occurs while getting the policy versions.
     */
