...
public class EntitlementsApiServiceImpl implements EntitlementsApiService {
    ...
    @Autowired
    ServerEntitlementsManagementService serverEntitlementsManagementService = new ServerEntitlementsManagementService();
    ...
    @Override
    public Response entitlementsPoliciesIdPatch(PolicyDTO policyDTO) {
